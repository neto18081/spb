                ...
                <div className='tw-flex tw-ml-28 tw-justify-around'>
                    ...
                    <div className='tw-flex tw-flex-col tw-w-1/2 tw-text-left'>
                        ...
                        <ul className='tw-flex'>
                            <li><a href='#' className={`tw-border-2 tw-border-black tw-bg-${produto.cor1}-400 tw-rounded-full tw-p-4 tw-mr-2 hover:tw-border-gold hover:border-2`}></a></li>
                        ...
                        <button className='tw-p-4 tw-border-none tw-w-2/5 tw-rounded-xl tw-bg-gold tw-text-white tw-font-bold hover:tw-bg-green tw-mt-10'>Adicionar ao carrinho</button>
                    </div>
                    {/* direita */}
