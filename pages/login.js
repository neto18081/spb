    ...
    return (
        <>
            ...
            <div className="tw-w-screen tw-h-min tw-flex tw-flex-col tw-pt-[200px] tw-pb-10">
                ...
                <h2 className='tw-mx-auto tw-w-min tw-flex tw-flex-start tw-text-8xl tw-mb-16 tw-font-bold'>Login</h2>
                ...
                <form className='tw-flex tw-justify-center tw-items-center tw-flex-col tw-w-3/5 tw-mx-auto tw-p-5'>
                    ...
                    <input type="submit" name="enviar" id="enviar" value="Log in" className='tw-border-2 tw-py-2 tw-rounded-2xl tw-bg-gold tw-text-white tw-font-bold tw-w-1/2 tw-cursor-pointer hover:tw-text-black' />

                    <h3 className='tw-mx-auto tw-mt-8'>Ainda não possui cadastro?</h3>
                    <Link href="/registro">
                        <a className="tw-mx-auto tw-text-md tw-font-bold hover:tw-underline hover:underline-offset-1">Cadastre-se</a>
                    </Link>
                </form>
