    ...
    return (
        <>
            ...
            <div className="tw-w-screen tw-h-min tw-flex tw-flex-col tw-pt-[200px] tw-pb-10">
                ...
                <section className='tw-flex tw-ml-28 tw-h-min'>
                    <div className='tw-bg-gold tw-w-2/5 tw-flex tw-justify-center tw-flex-col tw-items-center tw-p-10'>
                    ...
                    <div className='tw-border-2 tw-border-green tw-w-3/5 tw-flex tw-justify-center tw-mr-10'>
